...
import com.codepath.apps.simpletweets.fragments.FavoritesTimelineFragment;
import com.codepath.apps.simpletweets.fragments.FollowersListFragment;
import com.codepath.apps.simpletweets.fragments.FollowingListFragment;
...
public class ProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = getIntent().getLongExtra(com.codepath.apps.twitter.constants.Extras.USER_ID, -1);
