...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "Vv210xroduBZ4d8s1zyQgjmmh";
	public static final String REST_CONSUMER_SECRET = "vpRMtSk2CVR89m6cOjYKV4RSEXi0FuQ6hDah5BnJ6COuA7bvua";
