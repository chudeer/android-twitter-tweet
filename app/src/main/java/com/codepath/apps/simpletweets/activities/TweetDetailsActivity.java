...
public class TweetDetailsActivity extends BaseActivity implements ComposeTweetFragment.StatusUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Long id = getIntent().getLongExtra(com.codepath.apps.simpletweets.constants.Extras.TWEET_ID, -1L);
    ...
    protected void showAuthenticatedUserProfile() {
        ...
        intent.putExtra(com.codepath.apps.simpletweets.constants.Extras.USER_ID, authenticatedUser.getId());
    ...
    protected void showSearchResults(String query) {
        ...
        intent.putExtra(com.codepath.apps.simpletweets.constants.Extras.QUERY, query);
        startActivity(intent);
    }
    ...
    private void populateTweetDetails(final Tweet tweet) {
        ...
        ivUserPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(com.codepath.apps.simpletweets.constants.Extras.USER_ID, tweet.getUser().getId());
                startActivity(intent);
            }
        });
